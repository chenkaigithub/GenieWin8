...
namespace ThoughtWorks.QRCode.Codec.Reader.Pattern
{
	...
	public class FinderPattern
	{
		...
		internal static Line[] findLineAcross(bool[][] image)
		{
            ...
            List<object> lineAcross = new List<object>(10);
		...
		internal static Line[] findLineCross(Line[] lineAcross)
		{
            ...
            List<object> crossLines = new List<object>(10);
            List<object> lineNeighbor = new List<object>(10);
            List<object> lineCandidate = new List<object>(10);
		...
		internal static Point[] getCenter(Line[] crossLines)
		{
            ...
            List<object> centers = new List<object>(10);
