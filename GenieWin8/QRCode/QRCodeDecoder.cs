...
namespace ThoughtWorks.QRCode.Codec
{
	...
	public class QRCodeDecoder
	{
        ...
        internal List<object> results;
        internal List<object> lastResults  = new List<object>(10);
        
        internal static DebugCanvas canvas;
        public QRCodeImageReader imageReader;
		...
		virtual internal Point[] AdjustPoints
		{
			get
			{
                ...
                List<object> adjustPoints = new List<object>(10);
		...
		public virtual sbyte[] decodeBytes(QRCodeImage qrCodeImage)
		{
            ...
            List<object> results = new List<object>(10);
		...
		internal virtual int[][] imageToIntArray(QRCodeImage image)
		{
			...
			for (int y = 0; y < height; y++)            // y is the height x is the width
			{
            ...
            if (_debugMode)
            {
                Utilities.WriteTimespanToDebug("Time to convert image to int 2d array: ", sw);
                //Utilities.WriteBitmapToDrive(intImage);
            }
