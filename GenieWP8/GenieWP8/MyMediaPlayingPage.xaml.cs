...
namespace GenieWP8
{
    public partial class MyMediaPlayingPage : PhoneApplicationPage
    {
        ...
        private void BuildLocalizedApplicationBar()
        {
            ...
            appBarMenuItem_Source.Click += new EventHandler(appBarMenuItem_Source_Click);
            ...
            appBarMenuItem_Playing.IsEnabled = false;
        ...
        private void appBarMenuItem_Source_Click(object sender, EventArgs e)
        {
            NavigationService.Navigate(new Uri("/MyMediaSourcePage.xaml", UriKind.Relative));
        }
