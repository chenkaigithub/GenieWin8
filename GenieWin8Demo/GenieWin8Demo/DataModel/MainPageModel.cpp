...
using namespace GenieWin8Demo::Data;
...
DataSource::DataSource()
{
	...
	auto group1 = ref new DataGroup("WiFiSetting",
		"无线设置",
		"Assets/DarkGray.png");
	//group1->Items->Append(ref new DataItem("Group-1-Item-1",
	//	"Item Title: 1",
	//	"Item Subtitle: 1",
	...
	//	ITEM_CONTENT,
	//	group1));
	//group1->Items->Append(ref new DataItem("Group-1-Item-2",
	//	"Item Title: 2",
	//	"Item Subtitle: 2",
	//	"Assets/DarkGray.png",
	//	"Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
	//	ITEM_CONTENT,
	//	group1));
	//group1->Items->Append(ref new DataItem("Group-1-Item-3",
	//	"Item Title: 3",
	//	"Item Subtitle: 3",
	...
	//	ITEM_CONTENT,
	//	group1));
	//group1->Items->Append(ref new DataItem("Group-1-Item-4",
	//	"Item Title: 4",
	//	"Item Subtitle: 4",
	//	"Assets/DarkGray.png",
	//	"Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
	//	ITEM_CONTENT,
	//	group1));
	//group1->Items->Append(ref new DataItem("Group-1-Item-5",
	//	"Item Title: 5",
	//	"Item Subtitle: 5",
	//	"Assets/MediumGray.png",
	//	"Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
