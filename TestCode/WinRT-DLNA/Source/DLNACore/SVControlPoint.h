...
private:
	...
	void processDiscoveryResult(NPT_Result nr, const FrontEnd::InterfaceContext *ifctx, const NPT_String& location, const NPT_String& server, const NPT_String& xmpp, int maxAge, DeviceDesc *rootDeviceDesc, const UUID& uuid);
