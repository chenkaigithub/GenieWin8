...
void ::SDKSample::HttpClientSample::Scenario2::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::SDKSample::HttpClientSample::Scenario2::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::SDKSample::HttpClientSample::Scenario2::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&Scenario2::Start_Click);
        break;
    case 2:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::SDKSample::HttpClientSample::Scenario2::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&Scenario2::Cancel_Click);
        break;
    }
