...
void ::SDKSample::HttpClientSample::Scenario1::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::SDKSample::HttpClientSample::Scenario1::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::SDKSample::HttpClientSample::Scenario1::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&Scenario1::Start_Click);
        break;
    case 2:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::SDKSample::HttpClientSample::Scenario1::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&Scenario1::Cancel_Click);
        break;
    }
