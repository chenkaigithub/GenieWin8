...
void ::SDKSample::HttpClientSample::Scenario4::InitializeComponent()
{
    if (_contentLoaded)
        return;
    ...
    // Call LoadComponent on ms-appx:///Scenario4.xaml
    ::Windows::UI::Xaml::Application::LoadComponent(this, ref new ::Windows::Foundation::Uri(L"ms-appx:///Scenario4.xaml"), ::Windows::UI::Xaml::Controls::Primitives::ComponentResourceLocation::Application);
    ...
    // Get the TextBox named 'RequestBodyField'
    RequestBodyField = safe_cast<::Windows::UI::Xaml::Controls::TextBox^>(static_cast<Windows::UI::Xaml::IFrameworkElement^>(this)->FindName(L"RequestBodyField"));
    ...
    // Get the TextBox named 'BaseAddress'
    BaseAddress = safe_cast<::Windows::UI::Xaml::Controls::TextBox^>(static_cast<Windows::UI::Xaml::IFrameworkElement^>(this)->FindName(L"BaseAddress"));
...
void ::SDKSample::HttpClientSample::Scenario4::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::SDKSample::HttpClientSample::Scenario4::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&Scenario4::Start_Click);
        break;
    case 2:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::SDKSample::HttpClientSample::Scenario4::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&Scenario4::Cancel_Click);
        break;
    }
